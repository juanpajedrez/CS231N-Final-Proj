...
if __name__ == "__main__":
    for architecture in (train.constants.Architectures.DENSENET, train.constants.Architectures.VGG, train.constants.Architectures.RESNET):
        summary_writer = SummaryWriter(f'runs/{architecture}_adam_lr_5e5_relu_10epochs')
        train(architecture=architecture, optimiser=train.constants.Optimisers.ADAM, num_epochs=10)
